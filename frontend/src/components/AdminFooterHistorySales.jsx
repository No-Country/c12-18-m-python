export default function AdminFooterHistorySales() {
    return (
      <div className="bg-white m-1 p-2">        
        <div className="flex justify-between my-1">
          <div className=" w-40 sm:w-48 md:w-64">
            <span className="text-black font-bold uppercase text-xs sm:text-base flex justify-end">Total Earnings</span>
          </div>
